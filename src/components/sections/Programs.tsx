...
const programs = [
  {
    ...
    subjects: ["Matematik", "Türkçe", "Fen Bilimleri", "Sosyal Bilgiler"],
    badge: "Temel",
  ...
  },
  {
    ...
    subjects: ["Tüm LGS Dersleri", "Deneme Kulübü", "Soru Kampları", "Karne Analizi"],
    badge: "Yoğun",
